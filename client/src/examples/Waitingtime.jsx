  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "0", margin: "0" }}>
     ...
     <p style={{ fontSize: "18px", fontWeight: "normal", margin: "20px 0", textAlign: "left", maxWidth: "600px" }}>
       As a reminder of the style of your AI manager, "The manager sometimes has difficulty solving complex problems, approaches challenges with caution, tends to give in when ideas face opposition, and prefers guidance before taking on new tasks."
     </p>          
    </div>
  );
}
