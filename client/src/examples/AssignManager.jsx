    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          "The manager sometimes has difficulty solving complex problems, approaches challenges with caution, tends to give in when ideas face opposition, and prefers guidance before taking on new tasks."
        </p>
        <p style={{ 
          fontSize: "18px", 
          fontWeight: "normal", 
